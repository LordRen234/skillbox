...
public class RoadController {
    ...
    /** Здравствуйте) Данный код генерирует автомобили(кол-во указываем мы) разной массы и высоты, и высчитывает
     * стоимость проезда через кпп и его стоимость исходя из массы и высоты ТС.
     */
    {
